          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                $id = $_GET['id'];
                $data = mysqli_query($koneksi,"SELECT  * FROM tbl_biaya_kirim WHERE id_biaya_kirim='$id'");
                                ...
                                <label >List Jasa</label>
                                    <select class="form-control" name="jasa">
                                        ...
                                        while ($jasa = mysqli_fetch_array($QueryJasa)) {
                                            ...
                                            if ($id_jasa==$kota['id_jasa']) {
                                                $select="selected";
                                            }else {
                                                $select="";
                                            }
                                        ?>
                                            <option value="<?= $jasa['id_jasa']; ?>" <?= $select; ?>><?= $jasa['nama_jasa']; ?></option>
                                        <?php } ?>
                                    </select> 
                            </div>
